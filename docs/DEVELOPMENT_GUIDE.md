...
**Last verified:** 2026-08-23 08:00 UTC *(re-verified against `pyproject.toml` / `build_exe.py` / `dataforge/` HEAD `b373e7e`; Wave 5+6 12/12 DONE, venv ext4 recommendation)*
