...
**Last verified:** 2026-08-23 09:00 UTC *(re-verified against `dataforge/ui/app.py` + `views/*` HEAD `b373e7e`; Wave 5+6 12/12 DONE — virtualised timeline, HexView, plugin isolation)*
